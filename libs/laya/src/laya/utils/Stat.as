package laya.utils {
	...
	public class Stat {
		...
		public static function show(x:Number = 0, y:Number = 0):void {
			if (!Browser.onMiniGame && !Browser.onLimixiu && !Render.isConchApp && !Browser.onBDMiniGame && !Browser.onKGMiniGame && !Browser.onQGMiniGame && !Browser.onVVMiniGame && !Browser.onAlipayMiniGame && !Browser.onBLMiniGame) _useCanvas = true;
			_show = true;
			_fpsData.length = 60;
