	...
	public class Input extends Text {
		...
		public static function __init__():void {
			...
			if (Browser.onMobile)
			{
				...
				if(Browser.onMiniGame || Browser.onBDMiniGame || Browser.onQGMiniGame || Browser.onKGMiniGame || Browser.onVVMiniGame || Browser.onAlipayMiniGame || Browser.onBLMiniGame)
				{
					isTrue = true;
				}
